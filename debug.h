...
#define FORn(x,j) {printf("[(%s/%d) %s ]%s[]:", __FILE__, __LINE__, __func__, #x);for(size_t i = 0; x + i != j; i++){printf("%ld,", (long)(x[i])); fflush(stdin);}printf("\n");}
#define FORu(x,j) {printf("[(%s/%d) %s ]%s[]:", __FILE__, __LINE__, __func__, #x);for(size_t i = 0; x + i != j; i++){printf("%ld,", (unsigned long)(x[i])); fflush(stdin);}printf("\n");}
#define FORx(x,j) {printf("[(%s/%d) %s ]%s[]:", __FILE__, __LINE__, __func__, #x);for(size_t i = 0; x + i != j; i++){printf("%ld,", (unsigned long)(x[i])); fflush(stdin);}printf("\n");}
#define FORd(x,j) {printf("[(%s/%d) %s ]%s[]:", __FILE__, __LINE__, __func__, #x);for(size_t i = 0; x + i != j; i++){printf("%ld,", (double)(x[i])); fflush(stdin);}printf("\n");}
#define FORp(x,j) {printf("[(%s/%d) %s ]%s[]:", __FILE__, __LINE__, __func__, #x);for(size_t i = 0; x + i != j; i++){printf("%ld,", (void *)(x[i])); fflush(stdin);}printf("\n");}
#define FORs(x,j) {printf("[(%s/%d) %s ]%s[]:", __FILE__, __LINE__, __func__, #x);for(size_t i = 0; x + i != j; i++){printf("%ld,", (char *)(x[i])); fflush(stdin);}printf("\n");}
#define FORc(x,j) {printf("[(%s/%d) %s ]%s[]:", __FILE__, __LINE__, __func__, #x);for(size_t i = 0; x + i != j; i++){printf("%ld,", (char)(x[i])); fflush(stdin);}printf("\n");}
